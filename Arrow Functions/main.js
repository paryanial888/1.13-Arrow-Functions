...
const cost1 = parseFloat(prompt('Cost of amazon package 1:\n'));
const cost2 = parseFloat(prompt('Cost of amazon package 2: \n'));
const cost3 = parseFloat(prompt('Cost of amazon package 3: \n'));
